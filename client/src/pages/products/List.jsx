  ...
  return (
    <div className="w-100 container">
      <div className="list-container p-3 shadow border rounded-4">
        <div className="py-3 w-100 d-flex justify-content-between align-items-center gap-2">
          {" "}
          <Input className="form-control" placeholder="Rechercher par le nom" />
          <SelectObj titleOptions="Trier par stock" className="form-select" />
          <SelectObj
            titleOptions="Trier par ordre alphabétique"
